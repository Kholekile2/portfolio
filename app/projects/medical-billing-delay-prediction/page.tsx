        ...
        <div className="min-w-0 max-w-4xl">
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
              ...
              <li>High cardinality categoricals consolidated into clinically meaningful groups using documented mappings: Specialty 118 to 9, ICD10 2,387 to 9, Service.Centre 730 to 9, Posted.Billing.Group 75 to 13, Debtor.Status 20 to 7.</li>
              <li>Target variable engineered from the date fields as Processing.Time = Latest.Capture.Date minus Capture.Date, with a 14 day threshold producing the binary Processing.Class.</li>
