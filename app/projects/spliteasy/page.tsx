    ...
    <main className="page-shell min-h-screen px-6 py-12">
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
          ...
          <li>All API responses use plain DTO record types instead of returning ORM model objects directly, which avoids serialization issues and keeps API contracts clean.</li>
